...
export const metadata: Metadata = { title: "Crear cuenta | Work Leveling" }
...
export default async function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface relative overflow-hidden">
      <div className="absolute inset-0 bg-secondary opacity-5 blur-[100px] pointer-events-none" />
        ...
        <SignUp
          appearance={{
            elements: {
              ...
              formFieldInput: "bg-surface-container-lowest border-outline-variant text-on-surface focus:border-secondary focus:ring-secondary/20",
              formButtonPrimary: "bg-secondary text-on-secondary hover:bg-secondary/90 font-headline font-black uppercase tracking-widest transition-colors",
              footerActionText: "text-outline",
              footerActionLink: "text-secondary hover:text-secondary/80 font-bold",
            },
          }}
        />
      </div>
