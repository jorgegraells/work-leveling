    ...
    <div className="p-6 md:p-10 space-y-8">
      ...
      {localMissions.length === 0 ? (
        <div className="rounded-xl bg-surface-container-highest p-1 shadow-[0px_20px_40px_rgba(0,0,0,0.4)]">
          <div className="rounded-lg bg-surface-bright p-16 text-center space-y-4">
            <div className="w-20 h-20 rounded-2xl bg-surface-container-lowest flex items-center justify-center mx-auto">
              ...
              >
                <div className="rounded-lg bg-surface-bright p-5 space-y-4 h-full flex flex-col">
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`w-12 h-12 rounded-lg bg-surface-container-lowest flex items-center justify-center flex-shrink-0`}>
                      <span className={`material-symbols-outlined text-2xl ${mod.colorClass}`}>
                        {mission.icon}
                      </span>
                    </div>
                  ...
                  {/* Stats row: XP + Assigned + Completed */}
